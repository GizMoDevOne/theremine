...
(function(Th){
  ...
  const TR = {
    fr: {
      ...
      'help.cam.start.k': `Bouton caméra (en haut)`,
      'help.cam.start.d': `Allume la caméra. Ton image remplit le champ, derrière l'oscilloscope, pour te repérer.`,
    ...
    en: {
      ...
      'help.cam.start.k': `Camera button (top bar)`,
      'help.cam.start.d': `Turns the camera on. Your feed fills the field, behind the oscilloscope, so you can see yourself.`,
